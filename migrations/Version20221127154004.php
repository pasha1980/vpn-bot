...
final class Version20221127154004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, server_id INT DEFAULT NULL, is_active TINYINT(1) DEFAULT 0 NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F52993981844E6B7 (server_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE plan (id INT AUTO_INCREMENT NOT NULL, is_active TINYINT(1) NOT NULL, days_count INT NOT NULL, price DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE `order` ADD plan_id INT DEFAULT NULL;');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398E899029B FOREIGN KEY (plan_id) REFERENCES plan (id);');
        $this->addSql('CREATE INDEX IDX_F5299398E899029B ON `order` (plan_id);');
    }
